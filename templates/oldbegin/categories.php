<?php 
/**
 * `categories.php` é o arquivo dedicado a listagem de Categorias, e nao Artigos por Categoria
 * O arquivo dedicado a listagem de Artigos por Categoria eh `category.php`
 */
