...
$state['invalid']   = $state['current'] && ! isset($menus[$state['current']]);
...
# caso valor de $_GET[key] nao for compativel com nenhum menu registrado 
# redireciona removendo query string
if( URL::has('key') && $state['invalid'] ) {
    header( "Location: " . dash_url('customize/menus'), true, 404 );
    exit;
}
