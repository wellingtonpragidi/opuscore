...
function stylesheets(): void {
    ...
    # Bloco condicional para incluir estilos CSS especificos de editores,
    # dependendo da pagina atual e do editor configurado.
    # As condicoes verificam se e uma pagina de 'update', 'setting/insert' ou 'setting/update'.
    if(
