	...
	<div class="insert cn_40">
		...
		<form method="POST" action="<?php URL::current() ?>" enctype="multipart/form-data">
			...
			<input 
                ...
                value="<?= INPUT::GET('title') ?>" required 
            />
            ...
            <input type="hidden" name="target_type" value="category-article" />
		</form>
	</div>
	<div class="select cn_60 mt20">
		<table class="striped horz outline">
            <tr>
                ...
                <th>Título</th>
                <th title="Segmento são slugs da URL após a base <?= category_base() ?>/">
                    Segmento
                </th>
                <th>Data</th>
                <th title="Artigos associados a esta categoria">Nº</th>
