<div id="insert-router">
	...
	<form method="POST" action="<?= URL::current() ?>">
		...
		<div id="insert-title">
            <label for="title" class="screen_reader">Insira o título do article</label>
			<input 
                id="title" type="text" 
                placeholder="Insira o título do article" 
                name="title" value="<?= INPUT::GET('title') ?>" 
                autocomplete="off" autofocus 
            />
		</div>

		<button id="btn" type="submit" name="action" value="insert">REGISTRAR POST</button>
