...
class Seek {
    ...
    */
    ...
    public static function attachment_data( string $scope = 'larger' ): ?array {
        ...
        $dimension = Image::dimension_attrs( $attachment->{$scope} );
    ...
    /**
     * A coluna 'attachment' he da tabela 'media' que faz relacionamento com a tabela 'articles'
     * E toda coluna de tabela selecionada fazendo relacao com 'articles' pode ser incluido no "seek loop"
     */
    ...
    private static function chronos( string $column, int|string|null $format = null ): string {
        ...
        return chronos_translate(
            date( $dateset, strtotime($datecol) )
        );
    }
